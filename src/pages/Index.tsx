        ...
        <section id="sobre" className="bg-primary/5">
          <div className="section-container">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-stretch">
              <div className="flex flex-col h-full space-y-4 animate-fade-in-left text-center md:text-left mx-auto md:mx-0">
                ...
                <p className="text-sm mt-6 md:mt-auto text-foreground/70 bg-background/60 rounded-lg p-3 border border-primary/10 mx-auto md:mx-0 max-w-md md:max-w-none text-center md:text-left">
