      ...
      <main className="flex-1">
        ...
        <section id="solucoes" className="bg-primary text-primary-foreground">
          <div className="section-container">
            ...
            <div className="mt-6 xs:mt-8 text-center">
              ...
              <Button variant="outline" className="bg-accent text-accent-foreground hover:bg-accent/90 text-base px-6 py-3" asChild>
                <a href="https://contate.me/558132991184" target="_blank" rel="noopener noreferrer">
                  Solicitar proposta
                  <ArrowRight className="ml-2" />
                </a>
              </Button>
        ...
        <section id="contato" className="bg-primary text-primary-foreground">
          <div className="section-container text-center">
            ...
            <div>
              <Button size="lg" className="bg-accent text-accent-foreground hover:bg-accent/90 w-full xs:w-auto text-base xs:text-lg px-6 py-3" onClick={() => window.open("https://contate.me/558132991184", "_blank")}>
